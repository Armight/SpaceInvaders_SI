...
public class EspazioMatrizea extends JFrame {
	
	private static final long serialVersionUID = 1L;
	private static EspazioMatrizea nEspazioa;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					EspazioMatrizea frame = EspazioMatrizea.getEspazioa();
	...
	public static EspazioMatrizea getEspazioa() {  
		if (nEspazioa == null) {            
			nEspazioa = new EspazioMatrizea();     
		}                                   
		return nEspazioa;                   
	} 
}